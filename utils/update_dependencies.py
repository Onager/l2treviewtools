...
class DPKGControlWriter(DependencyFileWriter):
  ...
  _FILE_CONTENT = u'\n'.join([
      ...
      (u'Depends: {python2_dependencies:s}${{python:Depends}}, '
       u'${{misc:Depends}}'),
      u'Description: Python 2 module of log2reviewtools',
      ...
      (u'Depends: {python3_dependencies:s}${{python3:Depends}}, '
       u'${{misc:Depends}}'),
      u'Description: Python 3 module of log2reviewtools',
      u'{description_long:s}',
      u'',
      ...
      u'Description: tools for code reviews in log2timeline projects'
      u'{description_long:s}',
      u''])
